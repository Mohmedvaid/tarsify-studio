...
export function useEarningsSummary() {
  return useQuery({
    ...
    queryFn: () => api.get<EarningsSummary>(endpoints.earnings.summary),
  });
}
...
export function useEarningsBreakdown() {
  return useQuery({
    ...
    queryFn: () => api.get<EarningsBreakdown[]>(`${endpoints.earnings.summary}/breakdown`),
  });
}
...
export function usePayouts() {
  return useQuery({
    ...
    queryFn: () => api.get<Payout[]>(endpoints.earnings.payouts.list),
  });
}
...
export function useRequestPayout() {
  ...
  return useMutation({
    mutationFn: () => api.post<Payout>(endpoints.earnings.payouts.request),
    onSuccess: () => {
